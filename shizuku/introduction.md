...
Shizuku can help noradb shell sh /storage/emulated/0/Android/data/moe.shizuku.privileged.api/start.sh
mal apps uses system APIs directly with adb/root privileges with a Java process started with app_process.
